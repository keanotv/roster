...
import { path, ROSTER_ROUTE_NAMES, ROUTE_NAMES, UNAVAILABILITY_ROUTE_NAMES } from '@/constants/constants'
import { ref } from 'vue'
...
const routerLinks = [
  ...
  },
  {
    ...
    subLinks: [
    {
        ...
        path: path(ROUTE_NAMES.UNAVAILABILITY) + path(UNAVAILABILITY_ROUTE_NAMES.VIEW)
      },
      {
        title: 'View Rosters',
